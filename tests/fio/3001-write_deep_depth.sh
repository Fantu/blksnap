...
echo "---"
echo "FIO deep depth write test"
...
fio --directory "${MP_TEST_DIR}" --section write_deep_depth ./blksnap.fio
...
fio --directory "${IMAGE}/${MP_TEST_DIR}" --section write_deep_depth ./blksnap.fio
...
echo "FIO deep depth write test finish"
echo "---"
